...
/**
 * Models for the RunTicket application.
 * These classes represent the core data structures such as Customer, Event, Venue, and Information.
 * They encapsulate the attributes and behaviors relevant to each entity, such as managing event details, customer information, and venue specifics.
 *
